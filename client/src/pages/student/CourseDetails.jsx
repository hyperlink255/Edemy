...
const CourseDetails = () => {
  ...
  return courseData ? (
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 z-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        <div className='max-w-xl x-10 text-gray-500'>
          <h1 className='md:text-[34px] text-[28px] font-semibold text-gray-800'>{courseData.courseTitle}</h1>
        ...
        <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
          ...
          <div className='p-5'>
            <div className='flex items-center gap-2'>
              ...
              <p className='text-red-500'><span>5 days left at this price!</span></p>
            </div>
            ...
            <div className='flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500'>
              ...
              <p>{calculateCourseDuraton(courseData)}</p>
              </div>
