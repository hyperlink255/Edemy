  ...
  return (
    <>
      <div className='md:px-20 px-8 pt-10'>
        ...
        <table className='md:table-auto table-fixed w-full overflow-hidden mt-10 border border-gray-300'>
            ...
            {enrolledCourses.map((course, index) => (
              <tr key={index} className='border-b border-gray-500/20'>
                <td className='md:px-4 pl-2 md:pl-4 py-3 flex items-center space-x-3'>
                  ...
                  <div className='flex-1'>
                    ...
                    <div className="bg-gray-300 rounded w-full h-2">
                      <div
                        style={{
                          width: `${progressArray[index] ? (progressArray[index].lectureCompleted * 100) / progressArray[index].totalLectures : 0}%`
                        }}
                ...
                <td className='px-4 py-3 max-sm:hidden'>
                  {calculateCourseDuraton(course)}
                </td>
                <td className='px-4 py-3 max-sm:text-right'>
                  {progressArray[index] && `${progressArray[index].lectureCompleted} / ${progressArray[index].totalLectures} `} <span>Lactures</span>
                </td>
                <td className='px-4 py-3 max-sm:text-right'>
